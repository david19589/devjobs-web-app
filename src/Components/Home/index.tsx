...
function Home(props: {
  ...
  return (
    <>
      <div className="flex flex-wrap justify-center max-w-[1440px] mr-auto ml-auto relative">
        {filteredJobs.slice(0, visibleJobs).map((item, index) => {
          return (
            <div
              ...
              } flex cursor-pointer hover:shadow-md hover:shadow-gray-400 hover:scale-105 w-[336px] h-[272px] mb-[49px] mx-[24px] rounded-lg pr-[55px] pl-[32px] pb-[32px] group`}
            >
              <div>
                <div
